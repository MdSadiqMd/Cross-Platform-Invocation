...
// SVM is used to spwan an SOL account locally and test other than we running an solana-validator locally
// Go to Solana playground paste the Rust program, doenload .so file and paste it in the test directory
describe("Counter Program Tests", () => {
    let svm: LiteSVM;
    let programId: PublicKey;
    let dataAccount: Keypair;
    let userAccount: Keypair;
    const programPath = path.join(import.meta.dir, "double_it.so");
